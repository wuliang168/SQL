...
0-公司领导：      履职情况胜任素质测评(公司班子成员30%、分管领导50%、360度评价20%(部门负责人互评10%、下属员工10%))
...
UNION
select N'总部部门负责人' AS sEachLType,a.EID as EID,a.Score_Type1 as Score_Type1,e.Director2 as Score_EID,30 as Modulus,120 as EachLType,
...
---- 分管领导非部门负责人
UNION
select N'总部部门副职' AS sEachLType,a.EID as EID,a.Score_Type1 as Score_Type1,e.Director2 as Score_EID,30 as Modulus,210 as EachLType,
...
UNION
select N'总部部门副职' AS sEachLType,a.EID as EID,a.Score_Type1 as Score_Type1,b.EID as Score_EID,NULL as Modulus,230 as EachLType,
...
---- 分管领导非公司班子成员
UNION
select N'一级分支机构负责人' AS sEachLType,a.EID as EID,a.Score_Type1 as Score_Type1,e.Director2 as Score_EID,30 as Modulus,320 as EachLType,
...
UNION
select N'一级分支机构副职及二级分支机构经理室成员' AS sEachLType,a.EID as EID,a.Score_Type1 as Score_Type1,e.Director2 as Score_EID,30 as Modulus,410 as EachLType,
