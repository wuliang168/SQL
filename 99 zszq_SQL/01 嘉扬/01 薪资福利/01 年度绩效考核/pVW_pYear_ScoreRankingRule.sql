...
GO
ALTER VIEW [dbo].[pVW_pYear_ScoreRankingRule]
AS

---- 排名组数>5且排名<20% 或者 排名组数<5且考核评分>95 ----
select pYear_ID,DepScoreType,DepScoreTypeCount,DepID,0.3 as RankLevA,0.4 as RankLevB,0.3 as RankLevC,NULL as RankLevD,NULL as RankLevE
...
------ 业务部门
UNION
select pYear_ID,DepScoreType,DepScoreTypeCount,DepID,0.2 as RankLevA,0.4 as RankLevB,0.3 as RankLevC,0.1 as RankLevD,NULL as RankLevE
from pYear_DepScore a
...
------ 业务部门
UNION
select pYear_ID,DepScoreType,DepScoreTypeCount,DepID,0 as RankLevA,0.4 as RankLevB,0.4 as RankLevC,0.2 as RankLevD,NULL as RankLevE
from pYear_DepScore a
...
------ 职能部门
UNION
select pYear_ID,DepScoreType,DepScoreTypeCount,DepID,0 as RankLevA,0.4 as RankLevB,0.5 as RankLevC,0.1 as RankLevD,NULL as RankLevE
from pYear_DepScore a
where ((DepScoreTypeCount>5 and DepScoreRanking*1.00/DepScoreTypeCount>0.9)
or (DepScoreTypeCount<5 and DepScoreYear<85)) and DepScoreType=2
