...
dbo.eFN_getdepid2nd(a.DepID) as DepID2nd,a.Status as Status,b.AdminID as AdminID,b.MDID as MDID,c.SalaryPayID as SalaryPayID,c.SalaryPerMM as SalaryPerMM,
