...
GO
ALTER VIEW [dbo].[pVW_pEMPPensionPerYY]
AS

select a.pPensionUpdateID as pPensionUpdateID,a.PensionYear as PensionYear,a.EID as EID,a.BID as BID,a.Badge as Badge,a.Name as Name,b.Identification as CertNo,
