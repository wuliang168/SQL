...
GO
ALTER proc [dbo].[CSP_BackPay_import_AF]--CSP_BackPay_import_AF()
    @URID int,
    @leftid int,
    @RetVal int=0 output
AS
...
Begin
    ...
    -- 拷贝pBackPay_import的补发工资到pEmployeeEmoluBackPay
    update b
    ...
    from pBackPay_import a,pEmployeeEmoluBackPay b
