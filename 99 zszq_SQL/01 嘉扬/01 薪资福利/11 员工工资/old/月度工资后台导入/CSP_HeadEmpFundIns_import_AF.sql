...
GO
ALTER proc [dbo].[CSP_HeadEmpFundIns_import_AF]--CSP_HeadEmpFundIns_import_AF()
    @URID int,
    @RetVal int=0 output
AS
/*
...
Begin
    ...
    -- 拷贝pHeadEmpFundIns_import的五险一金(个人)到pEmployeeEmolu
    update b
    ...
    from pHeadEmpFundIns_import a,pEmployeeEmoluFundIns b
    ...
    -- 清除导入员工五险一金(个人)pHeadEmpFundIns_import
    delete from pHeadEmpFundIns_import where HeadContact=(select EID from SkySecUser where ID=@URID)
    -- 异常流程
	IF @@Error <> 0
	Goto ErrM
