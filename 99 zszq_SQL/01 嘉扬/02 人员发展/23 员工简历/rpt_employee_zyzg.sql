SELECT a.EID, a.Badge, a.SubTitle as Title, a.sdate, a.score, a1.SubTitle AS SUBJECT1, a1.sdate AS sdate1, a1.score AS score1/* ,a2.Title as SUBJECT2,a2.sdate as sdate2,a2.score  as score2,*/ , e.zqzgdate,
    e.qhzgdate
FROM (SELECT *
    FROM (SELECT c.*, c1.SubTitle, ROW_NUMBER() OVER (PARTITION BY eid
