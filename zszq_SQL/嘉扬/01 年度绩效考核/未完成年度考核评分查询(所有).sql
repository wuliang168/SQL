...
where a.SCORE_TYPE1 IN (1) and a.SCORE_STATUS=2 and ISNULL(a.Submit,0)=0
-- 总部部门负责人 总裁评分
UNION
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (1) and a.SCORE_STATUS=3 and ISNULL(a.Submit,0)=0
-- 总部部门负责人 董事长评分
UNION
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (1) and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (2) and a.SCORE_STATUS=2 and ISNULL(a.Submit,0)=0
-- 总部部门副职 分管领导评分
UNION
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (2) and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (10) and a.SCORE_STATUS=2 and ISNULL(a.Submit,0)=0
-- 子公司部门负责人 子公司总经理评分
UNION
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (10) and a.SCORE_STATUS=3 and ISNULL(a.Submit,0)=0
-- 子公司部门负责人 董事长评分
UNION
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (10) and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (24,5) and a.SCORE_STATUS=2 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (24,5) and a.SCORE_STATUS=3 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (24,5) and a.SCORE_STATUS=4 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (24,5) and a.SCORE_STATUS=5 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (24,5) and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 IN (25,6,7) and a.SCORE_STATUS=2 and ISNULL(a.Submit,0)=0
...
where a.SCORE_TYPE1 IN (25,6,7) and a.SCORE_STATUS=9 and e.SCORE_STATUS=1 AND ISNULL(e.submit,0)=1 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=4 and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=11 and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1 in (29,12,13) and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=13 and a.SCORE_STATUS=2 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=17 and a.SCORE_STATUS=2 and ISNULL(a.Submit,0)=0
-- 区域财务经理 计划财务部负责人未评分
UNION
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=17 and a.SCORE_STATUS=3 and ISNULL(a.Submit,0)=0
-- 区域财务经理 财务总监未评分
UNION
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=17 and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=19 and a.SCORE_STATUS=2 and ISNULL(a.Submit,0)=0
-- 综合会计 计划财务部负责人未评分
UNION
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=19 and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
--inner join eDetails as c on a.Score_EID=c.EID
--inner join odepartment as d on b.DepID=d.depid
--where a.SCORE_TYPE1=14 and a.SCORE_STATUS=2 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=14 and a.SCORE_STATUS=3 and ISNULL(a.Submit,0)=0
-- 营业部合规风控专员 合规风控总监未评分
UNION
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where a.SCORE_TYPE1=14 and a.SCORE_STATUS=9 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where NULL=15 and a.SCORE_STATUS=7 and ISNULL(a.Submit,0)=0
...
inner join eDetails as c on a.Score_EID=c.EID
inner join odepartment as d on b.DepID=d.depid
where NULL=16 and a.SCORE_STATUS=7 and ISNULL(a.Submit,0)=0