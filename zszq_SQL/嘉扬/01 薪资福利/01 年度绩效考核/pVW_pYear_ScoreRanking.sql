...
FROM pYear_Score a
LEFT join (select Score_Type1,COUNT(Score_Type1) as TotalNum,Score_EID from pYear_Score where Score_Type1=1 and Score_Status=9 GROUP by Score_Type1,Score_EID) as b on a.Score_Type1=b.Score_Type1 and b.Score_EID=a.Score_EID
LEFT join (select Score_Type1,COUNT(Score_Type1) as TotalRankNum,Score_EID from pYear_Score where Score_Type1=1 and Score_Status=9 AND ISNULL(isRanking, 0)=1 GROUP by Score_Type1,Score_EID) as c on a.Score_Type1=c.Score_Type1 and c.Score_EID=a.Score_EID
LEFT join (select EID,rank() OVER (partition BY Score_Type1,Score_EID ORDER BY ScoreYear DESC) as Ranking,Score_EID from pYear_Score where Score_Type1=1 and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID and d.Score_EID=a.Score_EID
...
,NULL as RankLevel,NULL as RankRatio,a.Score_EID as Score_EID
FROM pYear_Score a
LEFT join (select Score_Type1,COUNT(Score_Type1) as TotalNum,Score_EID from pYear_Score where Score_Type1=1 and Score_Status=9 GROUP by Score_Type1,Score_EID) as b on a.Score_Type1=b.Score_Type1 and a.Score_EID=b.Score_EID
LEFT join (select Score_Type1,COUNT(Score_Type1) as TotalRankNum,Score_EID from pYear_Score where Score_Type1=1 and Score_Status=9 AND ISNULL(isRanking, 0)=1 GROUP by Score_Type1,Score_EID) as c on a.Score_Type1=c.Score_Type1 and a.Score_EID=c.Score_EID
...
LEFT join (select EID,rank() OVER (partition BY Score_Type1 ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1=2 and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
...
LEFT join (select EID,rank() OVER (partition BY Score_Type1 ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1=10 and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
...
LEFT join (select EID,rank() OVER (partition BY Score_Type1 ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1=30 and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
WHERE a.Score_Status=9 AND a.Score_Type1=2 AND ISNULL(a.isRanking,0)=1
---- isRanking=NULL
UNION
SELECT a.EID as EID,a.Score_DepID as Score_DepID,a.Score_Type1 as Score_Type1,b.TotalNum as TotalNum,c.TotalRankNum AS TotalRankNum,a.isRanking as isRanking,NULL AS Ranking
...
LEFT join (select EID,rank() OVER (ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1 IN (24,5) and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
...
LEFT join (select EID,rank() OVER (ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1 IN (25,6,7) and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
...
LEFT join (select EID,rank() OVER (partition BY Score_DepID ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1=4 and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
...
LEFT join (select EID,rank() OVER (partition BY Score_DepID ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1=11 and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
...
from pYear_Score where Score_Type1 IN (12,29,13) and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) 
as d on a.EID=d.EID
...
LEFT join (select EID,rank() OVER (partition BY Score_Type1 ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1=17 and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
...
LEFT join (select EID,rank() OVER (partition BY Score_Type1 ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1=19 and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
...
LEFT join (select EID,rank() OVER (partition BY Score_Type1 ORDER BY ScoreYear DESC) as Ranking from pYear_Score where Score_Type1=14 and Score_Status=9 AND ISNULL(isRanking, 0)=1 AND ScoreYear is Not NULL) as d on a.EID=d.EID
