...
SELECT DISTINCT N'1-总部部门负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
...
UNION
SELECT DISTINCT N'1-总部部门负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
...
---- 战略企划部(702)
UNION
SELECT DISTINCT N'1-总部部门负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
...
UNION
SELECT DISTINCT N'1-总部部门负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director2 AS Score_EID,
...
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 1 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
AND a.kpidepid=c.DepID AND c.Director2 not in (1026,1027,1028,5587,5014,1022) AND c.Director2 is not NULL
...
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 1 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
AND a.kpidepid=c.DepID AND c.Director2 in (1026,1027,1028)
...
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 1 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
AND a.kpidepid=c.DepID AND c.Director2 in (5587,5014,1022)
--
-- 总部部门负责人 其他副职领导(副总裁(赵伟江：1026、高玮：1027)、财务总监(盛建龙：1028))考核 30%*20% Score_Status-4
UNION
SELECT DISTINCT N'1-总部部门负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,b.EID AS Score_EID,
...
UNION
SELECT DISTINCT N'2-总部部门副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'2-总部部门副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
...
UNION
SELECT DISTINCT N'2-总部部门副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
...
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 2 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'总部部门副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director2 AS Score_EID,
30 AS Weight1,40 AS Weight2,NULL AS Weight3,50 AS Modulus,
...
UNION
SELECT DISTINCT N'10-子公司部门行政负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'子公司合规总监' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1027 AS Score_EID,
...
UNION
SELECT DISTINCT N'子公司合规总监' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1343 AS Score_EID,
...
UNION
SELECT DISTINCT N'子公司合规总监' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1028 AS Score_EID,
...
-- Score_Status=0：自评完毕
-- Score_Status=1：胜任素质测评
-- Score_Status=2：子公司合规总监考核(部门年度工作计划和履职情况)
-- Score_Status=3：子公司总经理考核(部门年度工作计划和履职情况)
-- Score_Status=9：子公司董事长考核(部门年度工作计划和履职情况)
--
...
UNION
SELECT DISTINCT N'10-子公司部门行政负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-胜任素质测评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 10 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
--
-- 子公司部门行政负责人 子公司总经理(楼小平：1343)考核 (50%+30%)*40% Score_Status-3
UNION
SELECT DISTINCT N'10-子公司部门行政负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,
...
3 AS Score_Status,N'3-子公司总经理考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 10 AND a.pstatus = 1 AND a.kpidepid<>666 AND a.EID=d.EID and d.status not in (4,5)
--
-- 子公司部门行政负责人 子公司董事长(盛建龙：1028)考核 (50%+30%)*60% Score_Status-9
UNION
SELECT DISTINCT N'10-子公司部门行政负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,
(case when c.CompID=13 then (select Director2 from oDepartment where DepID=393) else (select Director2 from oDepartment where DepID=392) end) AS Score_EID,
...
UNION
SELECT DISTINCT N'10-子公司部门行政负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,5479 AS Score_EID,
...
WHERE a.perole = 10 AND a.pstatus = 1 AND a.kpidepid=666 AND a.EID=d.EID and d.status not in (4,5)
--
-- 子公司合规风控部行政负责人 子公司总经理(楼小平：1343)考核 (50%+30%)*20% Score_Status-3
UNION
SELECT DISTINCT N'10-子公司部门行政负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1343 AS Score_EID,
...
UNION
SELECT DISTINCT N'10-子公司部门行政负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1028 AS Score_EID,
...
-- Score_Status=5：公司总裁考核(履职情况)
-- Score_Status=9：公司董事长考核(履职情况)
--
-- 分公司负责人 自评 0% Score_Status-0
UNION
SELECT DISTINCT N'24-分公司负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'24-分公司负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-胜任素质测评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 24 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'24-分公司负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,(select Director from oDepartment where DepID=362) AS Score_EID,
...
UNION
SELECT DISTINCT N'24-分公司负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,(select Director from oDepartment where DepID=737) AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
...
UNION
SELECT DISTINCT N'24-分公司负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1026 AS Score_EID,
...
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 24 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
--
-- 分公司负责人 公司总裁(王青山：5014)考核 20%*30% Score_Status-5
UNION
SELECT DISTINCT N'24-分公司负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,5014 AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,30 AS Modulus,
...
UNION
SELECT DISTINCT N'24-分公司负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1022 AS Score_EID,
...
UNION
SELECT DISTINCT N'25-分公司副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'25-分公司副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-胜任素质测评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 25 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
---- 分公司负责人(Director)非空
UNION
SELECT DISTINCT N'25-分公司副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
...
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 25 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
AND c.Director is not NULL
--
-- 分公司副职 分管领导(赵伟江：1026)考核 (30%+40%+10%)*60% Score_Status-9
---- 分公司负责人(Director)非空
UNION
SELECT DISTINCT N'25-分公司副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1026 AS Score_EID,
...
UNION
SELECT DISTINCT N'5-一级营业部负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'5-一级营业部负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-胜任素质测评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 5 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'5-一级营业部负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,(select Director from oDepartment where DepID=362) AS Score_EID,
40 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
2 AS Score_Status,N'2-网点运营管理总部考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 5 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'5-一级营业部负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,(select Director from oDepartment where DepID=737) AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
3 AS Score_Status,N'3-法律合规部考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 5 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'5-一级营业部负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1026 AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,30 AS Modulus,
4 AS Score_Status,N'4-分管领导考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 5 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
--
-- 一级营业部负责人 公司总裁(王青山：5014)考核 20%*30% Score_Status-5
UNION
SELECT DISTINCT N'5-一级营业部负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,5014 AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,30 AS Modulus,
5 AS Score_Status,N'5-公司总裁考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 5 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'5-一级营业部负责人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1022 AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,40 AS Modulus,
9 AS Score_Status,N'9-公司董事长考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 5 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'6-一级营业部副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'6-一级营业部副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-胜任素质测评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 6 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'6-一级营业部副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
30 AS Weight1,40 AS Weight2,10 AS Weight3,40 AS Modulus,
2 AS Score_Status,N'2-一级营业部负责人考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 6 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
AND c.Director is not NULL
--
-- 一级营业部副职 分管领导(赵伟江：1026)考核 (30%+40%+10%)*60% Score_Status-9
---- 一级营业部负责人(Director)非空
UNION
SELECT DISTINCT N'6-一级营业部副职' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1026 AS Score_EID,
30 AS Weight1,40 AS Weight2,10 AS Weight3,60 AS Modulus,
9 AS Score_Status,N'9-分管领导考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 6 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'7-二级营业部经理室成员' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'7-二级营业部经理室成员' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
20 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-胜任素质测评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 7 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
---- 一级营业部负责人(Director)非空
UNION
SELECT DISTINCT N'7-二级营业部经理室成员' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
30 AS Weight1,40 AS Weight2,10 AS Weight3,40 AS Modulus,
2 AS Score_Status,N'2-一级营业部负责人考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 7 AND a.pstatus = 1 AND dbo.eFN_getdepid1st(a.kpidepid)=c.DepID AND a.EID=d.EID and d.status not in (4,5)
AND c.Director is not NULL
--
-- 二级营业部经理室成员 分管领导(赵伟江：1026)考核 (30%+40%+10%)*60% Score_Status-9
---- 一级营业部负责人(Director)非空
UNION
SELECT DISTINCT N'7-二级营业部经理室成员' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1026 AS Score_EID,
30 AS Weight1,40 AS Weight2,10 AS Weight3,60 AS Modulus,
9 AS Score_Status,N'9-分管领导考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 7 AND a.pstatus = 1 AND dbo.eFN_getdepid1st(a.kpidepid)=c.DepID AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'4-总部普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'4-总部普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
30 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
...
UNION
SELECT DISTINCT N'4-总部普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,ISNULL(c.Director,c.Director2) AS Score_EID,
...
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 4 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'11-子公司普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'11-子公司普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
30 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-员工互评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 11 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'11-子公司普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,ISNULL(c.Director,c.Director2) AS Score_EID,
70 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
9 AS Score_Status,N'9-子公司负责人考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 11 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'29-分公司普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'29-分公司普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
30 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-员工互评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 29 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'29-分公司普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
70 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
9 AS Score_Status,N'9-分公司负责人考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 29 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'12-一级营业部普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'12-一级营业部普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
30 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-员工互评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 12 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'12-一级营业部普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
70 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
9 AS Score_Status,N'9-一级营业部负责人考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 12 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'13-二级营业部普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'13-二级营业部普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,NULL AS Score_EID,
30 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
1 AS Score_Status,N'1-员工互评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.perole = 13 AND a.pstatus = 1 AND a.EID=d.EID and d.status not in (4,5)
...
UNION
SELECT DISTINCT N'13-二级营业部普通员工' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
30 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
2 AS Score_Status,N'2-二级营业部负责人考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 13 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND a.EID=d.EID and d.status not in (4,5)
AND c.Director<>(select Director from oDepartment where DepID=dbo.eFN_getdepid1st(a.kpidepid))
--
...
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 13 AND a.pstatus = 1 AND dbo.eFN_getdepid1st(a.kpidepid)=c.DepID AND a.EID=d.EID and d.status not in (4,5)
AND c.Director<>(select Director from oDepartment where DepID=a.kpidepid)
--
...
-- 14-营业部合规专员
-- Score_Status=0：自评完毕
-- Score_Status=2：营业部负责人考核(岗位工作完成情况和专业技术考核)(作废)
-- Score_Status=3：法律合规部负责人考核(岗位工作完成情况和专业技术考核)
-- Score_Status=9：合规总监考核(岗位工作完成情况和专业技术考核)
--
-- 营业部合规专员 自评 0% Score_Status-0
UNION
SELECT DISTINCT N'14-营业部合规专员' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
--UNION
--SELECT DISTINCT N'营业部合规专员' AS sType,c.HGEID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
--60 AS Weight1,40 AS Weight2,NULL AS Weight3,20 AS Modulus,
...
UNION
SELECT DISTINCT N'14-营业部合规专员' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,(select Director from oDepartment where DepID=737) AS Score_EID,
...
---- 法律合规部负责人(DepID:737)非合规总监
UNION
SELECT DISTINCT N'14-营业部合规专员' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1033 AS Score_EID,
...
--------- 营业部合规联系人 --------
-- 15-营业部合规联系人
-- Score_Status=7：法律合规部负责人考核(所兼合规工作)
--
-- 营业部合规联系人 法律合规部负责人(DepID:737)考核 30% Score_Status-7
UNION
SELECT DISTINCT N'15-营业部合规联系人' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,(select Director from oDepartment where DepID=737) AS Score_EID,
30 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
...
UNION
SELECT DISTINCT N'16-总部兼职合规专员' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,(select Director from oDepartment where DepID=737) AS Score_EID,
30 AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
7 AS Score_Status,N'7-法律合规部负责人考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
-- 17-营业部区域财务经理
-- Score_Status=0：自评完毕
-- Score_Status=2：营业部负责人考核(岗位工作完成情况和专业技术考核)
-- Score_Status=3：计划财务部负责人考核(岗位工作完成情况和专业技术考核)
-- Score_Status=9：财务总监考核(岗位工作完成情况和专业技术考核)
--
-- 营业部区域财务经理 自评 0% Score_Status-0
UNION
SELECT DISTINCT N'17-营业部区域财务经理' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
UNION
SELECT DISTINCT N'17-营业部区域财务经理' AS sType,c.CWEID AS EID,a.kpidepid AS Score_DepID,c.Director AS Score_EID,
60 AS Weight1,40 AS Weight2,NULL AS Weight3,20 AS Modulus,
...
UNION
SELECT DISTINCT N'17-营业部区域财务经理' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,(select Director from oDepartment where DepID=355) AS Score_EID,
60 AS Weight1,40 AS Weight2,NULL AS Weight3,30 AS Modulus,
...
---- 财务部负责人(DepID:355)非财务总监
UNION
SELECT DISTINCT N'17-营业部区域财务经理' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,1028 AS Score_EID,
60 AS Weight1,40 AS Weight2,NULL AS Weight3,50 AS Modulus,
...
-- 19-综合会计
-- Score_Status=0：自评完毕
-- Score_Status=2：区域财务经理考核(工作业绩、工作态度、工作能力和合规风控性)
-- Score_Status=9：计划财务部负责人考核(工作业绩、工作态度、工作能力和合规风控性)
--
-- 综合会计 自评 0% Score_Status-0
UNION
SELECT DISTINCT N'19-综合会计' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,a.EID AS Score_EID,
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,NULL AS Modulus,
0 AS Score_Status,N'0-自评' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
---- 部门区域财务经理(CWEID)非空
UNION
SELECT DISTINCT N'19-综合会计' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,c.CWEID AS Score_EID,
...
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 19 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND c.CWEID is not NULL AND a.EID=d.EID and d.status not in (4,5)
--
-- 综合会计 计划财务部负责人(DepID:355)考核 100%*60% Score_Status-9
---- 部门区域财务经理(CWEID)为非空
UNION
SELECT DISTINCT N'19-综合会计' AS sType,a.EID AS EID,a.kpidepid AS Score_DepID,(select Director from oDepartment where DepID=355) AS Score_EID,
...
9 AS Score_Status,N'9-计划财务部负责人考核' AS Score_StatusTitle,a.perole AS Score_Type1,a.pegroup AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.perole = 19 AND a.pstatus = 1 AND a.kpidepid=c.DepID AND c.CWEID is NULL AND a.EID=d.EID and d.status not in (4,5)