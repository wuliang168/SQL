...
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,30 AS Modulus,
10 AS Score_Status,N'1-履职情况胜任素质测评' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,70 AS Modulus,
20 AS Score_Status,N'2-战略企划部考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.Score_Type1=1 AND a.pstatus=1 AND a.EID=d.EID and d.status not in (4,5)
--
...
30 AS Weight1,NULL AS Weight2,NULL AS Weight3,30 AS Modulus,
10 AS Score_Status,N'1-履职情况胜任素质测评' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.Score_Type1=2 AND a.pstatus=1 AND a.EID=d.EID and d.status not in (4,5) AND a.kpidepidyy=737
--
...
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,30 AS Modulus,
10 AS Score_Status,N'1-员工互评' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
...
60 AS Weight1,30 AS Weight2,10 AS Weight3,70 AS Modulus,
...
70 AS Weight1,30 AS Weight2,NULL AS Weight3,100 AS Modulus,
99 AS Score_Status,N'99-总部部门负责人考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.Score_Type1=4 AND a.pstatus=1 AND a.EID=d.EID and d.status not in (4,5) and a.kpidepidyy=737
...
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,25 AS Modulus,
10 AS Score_Status,N'1-履职情况胜任素质测评' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.Score_Type1=31 AND a.pstatus=1 AND a.EID=d.EID and d.status not in (4,5)
--
...
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,60 AS Modulus,
20 AS Score_Status,N'2-网点运营管理总部考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.Score_Type1=31 AND a.pstatus=1 AND a.EID=d.EID and d.status not in (4,5)
--
...
NULL AS Weight1,NULL AS Weight2,NULL AS Weight3,15 AS Modulus,
30 AS Score_Status,N'3-法律合规部考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.Score_Type1=31 AND a.pstatus=1 AND a.EID=d.EID and d.status not in (4,5)
--
...
60 AS Weight1,30 AS Weight2,10 AS Weight3,70*0.60 AS Modulus,
...
60 AS Weight1,30 AS Weight2,10 AS Weight3,70*0.40 AS Modulus,
99 AS Score_Status,N'99-一级分支机构负责人考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.Score_Type1=33 AND a.pstatus=1 AND a.kpidepidyy=c.DepID AND a.EID=d.EID and d.status not in (4,5) 
and c.DepGrade=2 and c.Director<>c.Director2
...
70 AS Weight1,30 AS Weight2,NULL AS Weight3,1.00 AS Modulus,
99 AS Score_Status,N'99-合规总监考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.Score_Type1=14 AND a.pstatus=1 AND a.EID=d.EID and d.status not in (4,5)
...
70 AS Weight1,30 AS Weight2,NULL AS Weight3,30 AS Modulus,
20 AS Score_Status,N'2-分支机构负责人考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
...
70 AS Weight1,30 AS Weight2,NULL AS Weight3,30 AS Modulus,
30 AS Score_Status,N'3-财务部负责人考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,eEmployee d
WHERE a.Score_Type1=17 AND a.pstatus=1 AND a.EID=d.EID and d.status not in (4,5)
...
70 AS Weight1,30 AS Weight2,NULL AS Weight3,40 AS Modulus,
...
70 AS Weight1,30 AS Weight2,NULL AS Weight3,20 AS Modulus,
20 AS Score_Status,N'2-分支机构负责人考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
...
70 AS Weight1,30 AS Weight2,NULL AS Weight3,40 AS Modulus,
30 AS Score_Status,N'3-分支机构区域财务经理考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
...
UNION
SELECT DISTINCT N'综合会计' AS sType,a.EID AS EID,a.kpidepidyy AS Score_DepID,(select Director from oDepartment where DepID=355) AS Score_EID,
70 AS Weight1,30 AS Weight2,NULL AS Weight3,80 AS Modulus,
99 AS Score_Status,N'99-计划财务部负责人考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
...
UNION
SELECT DISTINCT N'10-子公司部门行政负责人' AS sType,a.EID AS EID,a.kpidepidyy AS Score_DepID,1028 AS Score_EID,
50 AS Weight1,30 AS Weight2,NULL AS Weight3,70 AS Modulus,
99 AS Score_Status,N'99-子公司总经理考核' AS Score_StatusTitle,a.Score_Type1 AS Score_Type1,a.Score_Type2 AS Score_Type2
FROM pEmployee_register a,oDepartment c,eEmployee d
WHERE a.Score_Type1=10 AND a.pstatus=1 AND a.kpidepidyy<>666 AND a.EID=d.EID and d.status not in (4,5)
AND a.kpidepidyy=c.DepID AND ISNULL(c.Director2,1028) in (1028,1343) AND c.CompID=13
...
30 AS Weight1,40 AS Weight2,NULL AS Weight3,30 AS Modulus,
...
30 AS Weight1,40 AS Weight2,NULL AS Weight3,70 AS Modulus,
