...
-- 员工明细
select a.PayRollMonth as PayRollMonth,d.DepAbbr as DepAbbr,b.SalaryPayID as SalaryPayID,a.EID as EID,a.EMP_Code as HRLID,c.Name as Name,a.SalaryTotal as SalaryTotal,
...
from pEMPPayRollPerMM a,pEmployeeEmolu b,eEmployee c,oDepartment d,oJob e
...
from pEMPPayRollPerMM a,pEmployeeEmolu b,eEmployee c,oDepartment d
