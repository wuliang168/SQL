...
d.OneTimeAnnualBonus as OneTimeAnnualBonus,e.FestivalFee1 as FestivalFee1,e.FestivalFee2 as FestivalFee2,e.FestivalFee3 as FestivalFee3,e.BenefitsInKind as BenefitsInKind,
...
left join pEmployeePension_all as b on a.EID=b.EID
inner join pEmployeeEmoluFundIns_all as c on a.EID=c.EID
inner join pEmployeeEmoluBonus_all as d on a.EID=d.EID
inner join pEmployeeEmoluFestivalFee_all as e on a.EID=e.EID
inner join pEmployeeEmoluBackPay_all as f on a.EID=f.EID
inner join pEmployeeEmoluAllowanceBT_all as g on a.EID=g.EID
inner join pEmployeeEmoluDeductionBT_all as h on a.EID=h.EID
inner join pEmployeeEmoluDeductionAT_all as i on a.EID=i.EID
inner join pEmployeeEmoluAllowanceAT_all as j on a.EID=j.EID
inner join pEmployeeEmoluTax_all as k on a.EID=k.EID