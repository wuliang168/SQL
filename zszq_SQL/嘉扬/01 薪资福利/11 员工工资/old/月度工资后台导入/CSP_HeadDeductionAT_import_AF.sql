...
GO
ALTER proc [dbo].[CSP_HeadDeductionAT_import_AF]--CSP_HeadDeductionAT_import_AF()
    @URID int,
    @RetVal int=0 output
AS
/*
...
Begin
    ...
    -- 拷贝pHeadDeductionAT_import的税后扣款到pEmployeeEmoluDeductionBT
    update b
    ...
    from pHeadDeductionAT_import a,pEmployeeEmoluDeductionAT b
    ...
    -- 清除导入员工税后扣款pHeadDeductionAT_import
    delete from pHeadDeductionAT_import where HeadContact=(select EID from SkySecUser where ID=@URID)
    -- 异常流程
	IF @@Error <> 0
	Goto ErrM
