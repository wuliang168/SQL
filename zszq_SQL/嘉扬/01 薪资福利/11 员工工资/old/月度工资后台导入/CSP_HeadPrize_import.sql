...
GO
ALTER proc [dbo].[CSP_HeadPrize_import]--CSP_HeadPrize_import()
    @URID int,
    @Badge varchar(10),
    @Name nvarchar(50),
    @BonusYear int,
...
Begin
    ...
    -- 将导入的文件插入到pHeadPrize_import表项中
    insert into pHeadPrize_import (HeadContact,Badge,BonusYear,BonusType,BonusAmount,BonusDepID,
    ...
    select (select EID from SkySecUser where ID=@URID),@Badge,@BonusYear,@BonusType,@BonusAmount,@BonusDepID,
    @BonusMonth1,@BonusAmount1,@BonusMonth2,@BonusAmount2,@BonusMonth3,@BonusAmount3,@BonusMonth4,@BonusAmount4,@BonusMonth5,
    @BonusAmount5,@BonusMonth6,@BonusAmount6,@BonusMonth7,@BonusAmount7,@BonusMonth8,@BonusAmount8,@BonusMonth9,@BonusAmount9,
    @BonusMonth10,@BonusAmount10,@BonusMonth11,@BonusAmount11,@BonusMonth12,@BonusAmount12,@Remark
    -- 异常流程
