...
Begin
    ...
    -- 更新pYear_AnnualBonus
    insert into pYear_AnnualBonus(ProcessID,Year,Date,AnnualBonusDepID,EMPDepID,BID,Identification,AnnualBonusType)
    select @ProcessID,
    ...
    @DepID,(select DepID from pVW_Employee where BID=@bid),@bid,(select Identification from pVW_Employee where BID=@bid),
