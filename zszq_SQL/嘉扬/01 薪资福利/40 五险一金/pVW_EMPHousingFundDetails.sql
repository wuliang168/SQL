...
a.EMPHousingFundLoc as EMPHousingFundLoc,a.HFRatioLocID as EMPHFRatioLocID,a.EMPHousingFundDepart as EMPHousingFundDepart,
...
-------- 公积金超额(个人)
NULL as EMPHousingFundOverEMP,
-------- 公积金超额(公司)
NULL as EMPHousingFundOverGRP
...
left join oCD_HousingFundRatioLoc d on a.HFRatioLocID=d.ID and ISNULL(d.IsDisabled,0)=0