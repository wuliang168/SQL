...
where a.DepID=b.DepID and ISNULL(dbo.eFN_getdepadmin(dbo.eFN_getdepid1st(a.DepID)),0)<>695
...
from eEmployee a,oDepartment b
where a.DepID=b.DepID and ISNULL(dbo.eFN_getdepid1st(a.DepID),0)=361
...
1992 as PreviewTo,dbo.eFN_getdepdirector(362) as ReportTo,362 as ReportToDepID
from eEmployee a,oDepartment b
where a.DepID=b.DepID and a.CompID=11
and a.Name=N'胡晶飚'