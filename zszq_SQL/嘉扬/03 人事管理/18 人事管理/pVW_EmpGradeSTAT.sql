...
COUNT(c.JoinMM) as 当月入职人数,COUNT(c.JoinYY) as 当年入职人数合计,COUNT(d.LeaMM) as 当月离职人数,COUNT(d.LeaYY) as 当年离职人数合计
from eCD_EmpGrade a
...
(case when DATEDIFF(YY,n.WorkBeginDate,GETDATE())<=5 then COUNT(m.EID) end) as WorkDate1t5YTT,
