...
------ 合规总监 100%
UNION
select a.pYear_ID,a.DepID,a.Director,SUM(ScoreTotal) as ScoreTotal,1 as Modulus,a.FDAppraiseEID as FDAppraiseEID,N'合规总监' as FDAppraiseTitle,2 as xOrder
from pFDAppraise a
where a.Status in (4) and a.FDAppraiseType in (8,9,10,17,18) and a.DepID=737
group by a.pYear_ID,a.DepID,a.Director,a.FDAppraiseEID
...
from pFDAppraise a
where a.Status in (5) and a.FDAppraiseType in (8,9,10,17,18) and a.FDAppraiseEID=1022 and a.DepID<>737
group by a.pYear_ID,a.DepID,a.Director,a.FDAppraiseEID
