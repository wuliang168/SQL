...
GO
ALTER  Procedure [dbo].[eSP_pDepSalaryPerMonthStart]
-- skydatarefresh eSP_pDepSalaryPerMonthStart
    @id int,  
    @RetVal int=0 Output
As
/*
...
Begin
    ...
    -- 部门月度工资流程已开启！
    If Exists(Select 1 From pDepSalaryPerMonth a Where a.ID=@id and a.IsSubmit is NULL)
    Begin
        Set @RetVal = 930096
        Return @RetVal
    End
