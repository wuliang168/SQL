...
GO
ALTER proc [dbo].[CSP_HeadDeductionBT_import_AF]--CSP_HeadDeductionBT_import_AF()
    @URID int,
    @RetVal int=0 output
AS
/*
...
Begin
    ...
    -- 拷贝pHeadDeductionBT_import的补发工资到pEmployeeEmoluDeductionBT
    update b
    ...
    from pHeadDeductionBT_import a,pEmployeeEmoluDeductionBT b
    ...
    -- 清除导入员工税前扣款pHeadDeductionBT_import
    delete from pHeadDeductionBT_import where HeadContact=(select EID from SkySecUser where ID=@URID)
    -- 异常流程
	IF @@Error <> 0
	Goto ErrM
