...
b.姓名 AS name, '' AS oldname, b.性别 AS sex, ISNULL(c1.Title, N'汉族') AS mingzu, b.出生日期 AS csrq, b.年龄 AS age, c4.Title AS jiguan, c.BirthPlace AS csd, ISNULL(b.政治面貌, N'群众') 
AS zzmb, c2.Title AS hyzk, b.开始工作日期 AS ksgzrq, '' AS email,c.Mobile as Mobile, b.入职日期 AS joindate, (CASE WHEN c.RESIDENT = '02' THEN N'农业户口' ELSE N'非农业户口' END) AS hukou, 
c.residentAddress, b.最高学历 AS maxxueli, b.最高学位 AS maxxuewei, N'社会招聘' AS rzly, N'技术岗位' AS gwlb, N'合同制' AS rylb, N'否' AS isjtzc, b.国籍 AS nation, N'是' AS sfnrgongzi
